...
This repository contains all the SSA English subtitles I've worked on or fixed to match the most common anime home releases. It may be slowly updated with more anime if I manage to find the time needed to do this. As of Feb 2021, I still have a few years worth of movies and subs that I'd like to sub but I'm probably taking a break for now (it's extremely time-consuming, and a bit of a waste of time really).
...
|ARIA The AVVENIRE|Kickstarter BD|Nozomi Official (Extracted)|Minor to moderate|Yes|All lines|Minor|Yes, includes inserts|
